...
def main():
    ...
    with Pool(10) as p: #Diez hilos en una sola iteracion
        p.map(descarga_url_img, imagenes)
    t2 = time.perf_counter() #Contador final
    print(f'El codigo en base a multiprocesamiento le tomo: {t2 - t1} segundos.')
