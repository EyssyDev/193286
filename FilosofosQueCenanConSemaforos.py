...
class TenedorFilosofo(threading.Thread):
    def __init__(self, tenedores, filosofosNum):
        ...
        self.datoTemporal =  self.filosofosNum
    ...
    def hilosFilosofos(self):
        while True:
            ...
            print("Filosofo ", self.filosofosNum, "libera el tenedor derecho")
            ...
            print("Filosofo ", self.filosofosNum, "libera el tenedor izquierdo")
